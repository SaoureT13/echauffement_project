...
function DropDownEditCustomers({ customer, icon }) {
            ...
            {showDropdown && (
                <div className="absolute right-0 mt-2 w-36 bg-white rounded-md shadow-lg border border-gray-200 z-10">
                    <ul className="py-1">
                        <li>
                            <a
                                href={`http://localhost:5374/customers.html?id=${
                                    customer.id
                        ...
                        <li>
                            <a
                                href={`http://localhost:5374/customers_ajax.html?id=${
                                    customer.id
                                }&name=${encodeURIComponent(
                                    customer.name
                                )}&phone=${encodeURIComponent(
...
export default DropDownEditCustomers;
