...
function DropDownAddProduct({ icon }) {
    ...
    return (
        <div className="relative">
            <button
                ...
                className={`cursor-pointer px-2 py-1 rounded-full transition-all duration-200 ease-in-our ${
                    showDropdown ? "" : ""
                }`}
            >
                {icon}
            ...
            {showDropdown && (
                <div className="absolute right-0 mt-2 w-36 bg-white rounded-md shadow-lg border border-gray-200 z-10">
                    <ul className="py-1">
                        <li>
                            <a
                                href={`http://localhost:5374/products.html`}
                        ...
                        <li>
                            <a
                                href={`http://localhost:5374/products_ajax.html`}
                                className="w-full px-4 py-2 text-sm hover:bg-gray-100 flex items-center gap-2 cursor-pointer"
                            >
                                <Pencil width={18} />
                                With AJAX
